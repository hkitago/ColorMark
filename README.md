...
1. Load the web page.
2. Select the text within the web page. The extension also supports the 'ColorMark' command from the context menu.
3. Tap the icon next to the address bar and choose the extension.
4. A window will slide up from the bottom on iPhone, or a pop-up window will appear on iPad and Mac; edit your default color or Marks or something.
...
- Support Page: [hkitago/TextClipHistory](https://github.com/hkitago/ColorMark/)
